...
public class LocationsMainPresenter implements Initializable {
    ...
    private ExportLocationsService service;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //we provide the locations in the constructor
        service = new ExportLocationsService(model.getLocations());
    ...
    private void populateListWithData() {
        model.setLocations(Arrays.asList(
